<x-app-layout>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs scroll-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{route('supplements')}}">Supplements</a>
                        </li>
                        <li class="nav-item">
  ...
  <input type="text" id="search-input" placeholder="Rechercher...">
                    ...
                    <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        @foreach($supplementss as $item)
                                                        @if ($item->created_at == $supplementss->max('created_at') && $item->user_id == Auth::id())
                                                            <tr>
                                                ...
                                                {{ $supplementss->onEachSide(0)->links() }}
