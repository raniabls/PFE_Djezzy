<x-app-layout>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs scroll-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{route('bmapvalues')}}">BMAP values</a>
                        </li>
                        <li class="nav-item">
  ...
  <input type="text" id="search-input" placeholder="Rechercher...">
                    ...
                    <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        @foreach($bmapvaluess as $item)
                                                        @if ($item->created_at == $bmapvaluess->max('created_at') && $item->user_id == Auth::id())
                                                            <tr>
                                                                <td>{{$item->layer}}</td>
                                                ...
                                                {{ $bmapvaluess->onEachSide(0)->links() }}
